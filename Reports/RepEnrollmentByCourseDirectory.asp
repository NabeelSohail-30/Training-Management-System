...
QryStr = "SELECT * FROM Rep_EnrollmentPerCourseDirectory ORDER BY CourseDirectoryId"
...
<body>
    <header>
        ...
        <h3 class="text-center">Enrollment Detail By Course Directory Report</h3>
    </header>
        ...
        <div class="container-fluid">
            <%
                do while NOT RSEnrollmentDetail.EOF
                    CourseDirectoryId = RSEnrollmentDetail("CourseDirectoryId")
            %>
                    ...
                    <div class="row">
                        <div class="col-3">
                            <div class="form-group">
                                <label for="" class="input-heading">Course Directory Id</label>
                                <label
                    ...
                    <table class="table table-bordered" style="width: 98%;">
                        ...
                        <tbody>
                            <%
                                ...
                                Counter = 1
                                do while RSEnrollmentDetail("CourseDirectoryId") = CourseDirectoryId
