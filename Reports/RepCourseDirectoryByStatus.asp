...
QryStr = "SELECT * FROM Rep_CourseDirectory " & Filter & " ORDER BY CourseDirectoryStatus"
...
<head>
    ...
    <title>Course Directory By Course Directory Status</title>
</head>

<body>
    <header>
        <h1 class="text-center">Training Management System</h1>
        <h3 class="text-center">Course Directory by Course Directory Status</h3>
    </header>

    <%
        dim mCourseDirectoryStatus
        do while NOT RSCourseDirectory.EOF
            mCourseDirectoryStatus = RSCourseDirectory("CourseDirectoryStatus")
            
    %>
    <main>
        <table class="table table-bordered" style="width: 95%;">
            <h4 class="text-center mt-2"><% response.write(mCourseDirectoryStatus) %></h4>
            <thead>
                <tr>
            ...
            <tbody>
                <%
                            Counter = 1
                            do while RSCourseDirectory("CourseDirectoryStatus") = (mCourseDirectoryStatus)
                %>
                <tr>
            ...
            <tfoot>
                <tr>
                    <td colspan="11">
                        <h5>Total Course Directories for Status (<% response.Write(mCourseDirectoryStatus) %>) :
