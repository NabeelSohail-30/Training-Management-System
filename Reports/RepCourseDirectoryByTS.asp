...
QryStr = "SELECT * FROM Rep_CourseDirectory " & Filter & " ORDER BY TimeSlot"
...
<head>
    ...
    <title>Course Directory By Time Slot</title>
</head>

<body>
    <header>
        <h1 class="text-center">Training Management System</h1>
        <h3 class="text-center">Course Directory by Time Slot</h3>
    </header>

    <%
        dim mTimeSlot
        do while NOT RSCourseDirectory.EOF
            mTimeSlot = RSCourseDirectory("TimeSlot")
    ...
    <main>
        <table class="table table-bordered" style="width: 90%;">
            ...
            <tbody>
                <%
                            Counter = 1
                            do while RSCourseDirectory("TimeSlot") = (mTimeSlot)
                %>
                <tr>
            ...
            <tfoot>
                <tr>
                    <td colspan="11">
                        <h5>Total Course Directories in Time Slot (<% response.Write(mTimeSlot) %>) :
