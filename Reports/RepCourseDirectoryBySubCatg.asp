...
QryStr = "SELECT * FROM Rep_CourseDirectory " & Filter & " ORDER BY SubCategory"
...
<head>
    ...
    <title>Course Directory By Sub Category</title>
</head>

<body>
    <header>
        <h1 class="text-center">Training Management System</h1>
        <h3 class="text-center">Course Directory by Sub Category</h3>
    </header>

    <%
        dim mSubCategory
        do while NOT RSCourseDirectory.EOF
            mSubCategory = RSCourseDirectory("SubCategory")
            
    %>
    <main>
        <table class="table table-bordered" style="width: 95%;">
            <h4 class="text-center mt-2"><% response.write(mSubCategory) %></h4>
            <thead>
                <tr>
            ...
            <tbody>
                <%
                    Counter = 1
                    do while RSCourseDirectory("SubCategory") = (mSubCategory)
                %>
                <tr>
            ...
            <tfoot>
                <tr>
                    <td colspan="11">
                        <h5>Total Course Directories in Sub Category (<% response.Write(mSubCategory) %>) :
