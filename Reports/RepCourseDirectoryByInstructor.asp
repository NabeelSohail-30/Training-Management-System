...
QryStr = "SELECT * FROM Rep_CourseDirectory " & Filter & " ORDER BY InstructorName"
...
<head>
    ...
    <title>Course Directory By Instructor</title>
</head>

<body>
    <header>
        <h1 class="text-center">Training Management System</h1>
        <h3 class="text-center">Course Directory by Instructor</h3>
    </header>

    <%
        dim mInstructor
        do while NOT RSCourseDirectory.EOF
            mInstructor = RSCourseDirectory("InstructorName")
            
    %>
    <main>
        <table class="table table-bordered" style="width: 95%;">
            <h4 class="text-center mt-2"><% response.write(mInstructor) %></h4>
            <thead>
                <tr>
            ...
            <tbody>
                <%
                            Counter = 1
                            do while RSCourseDirectory("InstructorName") = (mInstructor)
                %>
                <tr>
            ...
            <tfoot>
                <tr>
                    <td colspan="11">
                        <h5>Total Course Directories for Instructor (<% response.Write(mInstructor) %>) :
